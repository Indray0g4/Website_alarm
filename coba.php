...
<div class="">
  <audio id="myAudio">
    <source src="audio/<?php echo $hari['Audio']; ?>" type="audio/mpeg">
  </audio>

  <button onclick="mainkan()" type="button" class="btn btn-primary"><i class="far fa-play-circle"></i> Play</button>
  <button onclick="berhenti()" type="button" class="btn btn-primary"><i class="far fa-pause-circle"></i> Pause</button> 
</div>
